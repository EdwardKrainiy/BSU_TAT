...
public class LandingPage {
    ...
    public WebElement getCloseAdButton(){
        try {
            return new WebDriverWait(driver, 2).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.className("popmechanic-close"))).get(0);
        } catch (Exception e){
    ...
    public WebElement getCloseChatButton(){
        try {
            return new WebDriverWait(driver, 2).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.className("support-close"))).get(0);
        } catch (Exception e){
